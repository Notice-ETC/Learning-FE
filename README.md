...
- **Primary**: `#C9B59C` (น้ำตาลอ่อน) - ใช้สำหรับข้อความหลักและปุ่ม
- **Secondary**: `#D9CFC7` (เบจอ่อน) - ใช้สำหรับข้อความรอง
- **Background**: `#EFE9E3` (ครีม) - ใช้สำหรับพื้นหลัง
- **Paper/Light**: `#F9F8F6` (ขาวครีม) - ใช้สำหรับ card และพื้นหลังอ่อน
